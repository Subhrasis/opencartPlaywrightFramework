...
class CheckoutPage:
    ...
    def __init__(self, page: Page):
        ...
        self.txt_first_name = self.page.locator('#input-shipping-firstname')
        self.txt_last_name = self.page.locator('#input-shipping-lastname')
        self.txt_address1 = self.page.locator('#input-shipping-address-1')
        self.txt_city = self.page.locator('#input-shipping-city')
        self.txt_pin = self.page.locator("#input-shipping-postcode")
        self.drp_country = self.page.locator("#input-shipping-country")
        self.drp_state = self.page.locator("#input-shipping-zone")
        self.btn_continue = self.page.locator("#button-shipping-address")
